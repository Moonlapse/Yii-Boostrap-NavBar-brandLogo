<?php
/** Edited NavBar with $brandLogo class **/
...
class NavBar extends Widget
{
    ...
    /* Adding Logo Array */
    public $brandLogo = false;
    /**
     *Adding logo img URL to NavBar with brand Label
     * 
     */
    ...
    public function init()
    {
        ...
        if ($this->brandLogo !== false) {
            Html::addCssClass($this->brandOptions, 'navbar-brand');
            echo Html::a($this->brandLogo, $this->brandUrl === false ? Yii::$app->homeUrl : $this->brandUrl, $this->brandOptions);
        }
        /* DANGER END */
